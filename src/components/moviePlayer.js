...
import { View, Text, TouchableOpacity, Slider, ActivityIndicator, Modal, Platform, StyleSheet } from 'react-native'
...
class MoviePlayer extends Component {
  ...
  play() {
    this.setState({
      ...
      playIcon: this.state.paused ? 'pausecircleo' : 'playcircleo'
    })
  }
      ...
      <TouchableOpacity
            ...
            <View style={styles.navContentStyle}>
              <View style={{flexDirection: 'row', alignItems: commonStyle.center, flex: 1}}>
                <TouchableOpacity
                  ...
                  onPress={orientation === 'PORTRAIT' ? () => console.log('pop') : Orientation.lockToPortrait}>
                  <AntDesign name={'left'} size={18} color={commonStyle.white}/>
                </TouchableOpacity>
              ...
              <View style={{flexDirection: 'row', alignItems: commonStyle.center, justifyContent: commonStyle.between}}>
                <TouchableOpacity
                  ...
                  onPress={() => alert('切换电视！')}>
                  <Feather name={'tv'} size={20} color={commonStyle.white}/>
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.navToolBar}
                  onPress={() => alert('开启VR！')}>
                  <AntDesign name={'videocamera'} size={20} color={commonStyle.white}/>
                </TouchableOpacity>
                {
                  orientation !== 'PORTRAIT' ?
                    <View style={{flexDirection: commonStyle.row, alignItems: commonStyle.center}}>
                      ...
                      <TouchableOpacity
                        style={styles.navToolBar}
                        onPress={() => alert('分享！')}>
                        <AntDesign name={'oneIcon|share_dot_o'} size={20} color={commonStyle.white}/>
                      </TouchableOpacity>
                      <TouchableOpacity
                        style={styles.navToolBar}
                        onPress={() => alert('下载！')}>
                        <AntDesign name={'oneIcon|download_o'} size={20} color={commonStyle.white}/>
                      </TouchableOpacity>
                      <TouchableOpacity
                        style={styles.navToolBar}
                        onPress={() => alert('设置画面！')}>
                        <AntDesign name={'oneIcon|more_v_o'} size={20} color={commonStyle.white}/>
                      </TouchableOpacity>
                    </View> : null
                }
              </View>
        ...
        }
        {
          orientation !== 'PORTRAIT' ?
            ...
            >
              <AntDesign name={`${this.state.isLock ? 'locked_o' : 'unlocked_o'}`} size={20} color={commonStyle.white} style={{backgroundColor: commonStyle.blue}}/>
          ...
          this.state.isTouchedScreen && !isLock ?
            <View style={[styles.toolBarStyle, {marginBottom: Platform.OS === 'ios' ? 0 : orientation !== 'PORTRAIT' ? 25 : 0}]}>
              <TouchableOpacity onPress={() => this.play()}>
                <AntDesign name={`${this.state.playIcon}`} size={18} color={commonStyle.white}/>
              </TouchableOpacity>
              ...
              </View>
              {
                orientation === 'PORTRAIT' ?
                  <TouchableOpacity onPress={Orientation.lockToLandscapeLeft}>
                    <MaterialIcons name={'fullscreen'} size={18} color={ commonStyle.white } />
                  </TouchableOpacity> :
                  <TouchableOpacity onPress={Orientation.lockToPortrait}>
                    <MaterialIcons name={'fullscreen-exit'} size={18} color={ commonStyle.white } />
                  </TouchableOpacity>
              }
